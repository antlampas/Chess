...
class board{
    ...
    */
    ...
    private:
        ...
        int upperColumnFreeSquare(int,std::string,std::string);
        int lowerColumnFreeSquare(int,std::string,std::string);
        int rightRowFreeSquare(int,std::string,std::string);
        int leftRowFreeSquare(int,std::string,std::string);
    public:
        board();
        board(boardMapType);
